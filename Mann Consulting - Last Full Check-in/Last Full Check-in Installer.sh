...
echo "Uploading computerextensionattributes/JMF Deploy - Last Full Check-in.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computerextensionattributes" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computerextensionattributes/JMF Deploy - Last Full Check-in.xml"
echo ""
sleep 20

echo "Uploading computergroups/JMF Deploy - Last Full Check-in = Fail.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Last Full Check-in = Fail.xml"
sleep 20
echo ""

echo "Uploading computergroups/JMF Deploy - Last Full Check-in = Pass.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Last Full Check-in = Pass.xml"
sleep 20
echo ""

echo "Uploading policies/zzzz JMF Deploy - Policies Finished.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/policies" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/policies/zzzz JMF Deploy - Policies Finished.xml"

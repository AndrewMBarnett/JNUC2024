...
echo "Uploading computerextensionattributes/JMF Deploy - Last Full Inventory.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computerextensionattributes" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computerextensionattributes/JMF Deploy - Last Full Inventory.xml"
sleep 20
echo ""

echo "Uploading computergroups/JMF Deploy - Last Full Inventory = Pass.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Last Full Inventory = Pass.xml"
sleep 20
echo ""

echo "Uploading computergroups/JMF Deploy - Last Full Inventory = Fail.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Last Full Inventory = Fail.xml"

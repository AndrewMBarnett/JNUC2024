...
echo "Uploading computerextensionattributes/JMF Deploy - Employee Is Active.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computerextensionattributes" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computerextensionattributes/JMF Deploy - Employee Is Active.xml"
sleep 20
echo ""

echo "Uploading computergroups/JMF Deploy - Employee Is Active = Pass.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Employee Is Active = Pass.xml"
sleep 20
echo ""

echo "Uploading computergroups/JMF Deploy - Employee Is Active = Fail.xml"
curl -sS -H "Authorization: Bearer $authorizationToken" "$jamfpro_url/JSSResource/computergroups" -H "Content-Type: application/xml" -X "POST" --data-binary "@$baseDir/computergroups/JMF Deploy - Employee Is Active = Fail.xml"
